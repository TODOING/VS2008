...
typedef Eigen::Matrix<double, Dynamic, Dynamic, ColMajor> CMatrix;
...
typedef Eigen::Matrix<double, Dynamic, Dynamic, RowMajor, INT_MAX, INT_MAX> MyMatrix;
...
public: 
	...
	int ExecuteMatrixRXD(const char* pszRXDFile, int iBandCount = -1, const char* pszFormat = "GTiff");
private:
	/**
...
private: 
	...
	MyMatrix m_srcDataMatrix;
	MyMatrix m_srcInvCovarianceMatrix;
};
